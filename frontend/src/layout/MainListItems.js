...
const useStyles = makeStyles((theme) => ({
  ...
  logoutButton: {
    ...
    color: "#FFFFFF",
    "&:hover": {
      backgroundColor: theme.palette.sair.main, // Mantém a cor original ou ajusta levemente
      opacity: 0.9, // Um leve efeito visual
...
function ListItemLink(props) {
  ...
  return (
    <li>
      <ListItem button dense selected={selected} component={renderLink} className={className}>
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        console.log("Error fetching plan configs", e);
      }
    }
    fetchData();
    // eslint-disable-next-line react-hooks/exhaustive-deps
