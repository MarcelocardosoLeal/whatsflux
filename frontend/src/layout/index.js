...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    backgroundColor: theme.mode === 'light' ? '#f0f2f5' : '#121212',
    backgroundImage: theme.mode === 'light'
      ...
      : `radial-gradient(at 0% 0%, hsla(140, 60%, 20%, 0.1) 0, transparent 50%), 
         radial-gradient(at 50% 100%, hsla(220, 60%, 20%, 0.1) 0, transparent 50%)`, // Subtle dark mesh
  ...
  toolbar: {
    paddingRight: 24,
    color: "white", // Force white color for all children elements
    // User requested: Dark Green Gradient
    background: theme.mode === 'light'
      ? 'linear-gradient(to right, #00695C, #004D40)'
      : 'rgba(30, 30, 30, 0.7)',
    backdropFilter: theme.mode === 'light' ? 'none' : 'blur(10px)',
  ...
  toolbarIcon: {
    ...
    padding: "0 8px",
    minHeight: "48px",
    color: "white", // Force white here too
    [theme.breakpoints.down("sm")]: {
      height: "48px"
    }
  },
  appBar: {
    ...
    boxShadow: 'none', // Remove solid shadow for glass effect
  },
  appBarShift: {
  ...
  title: {
    flexGrow: 1,
    fontSize: 14,
    color: "white", // Always white as requested
  },
  drawerPaper: {
    position: "relative",
    whiteSpace: "nowrap",
          ...
          <div>
            ...
            >
              <MenuItem onClick={toggleColorMode}>
                {theme.mode === 'dark' ? (
                  <>
                    <Brightness7Icon style={{ marginRight: 10, color: "#BFBFBF" }} /> Modo Claro
                  </>
                ) : (
                  <>
                    <Brightness4Icon style={{ marginRight: 10, color: "#BFBFBF" }} /> Modo Escuro
                  </>
                )}
              </MenuItem>
              <MenuItem onClick={handleOpenUserModal}>
                <PersonIcon style={{ marginRight: 10, color: "#BFBFBF" }} /> {i18n.t("mainDrawer.appBar.user.profile")}
              </MenuItem>
              <MenuItem onClick={handleClickLogout}>
                <PowerSettingsNewIcon style={{ marginRight: 10, color: "#BFBFBF" }} /> {i18n.t("Sair")}
              </MenuItem>
            </Menu>
          </div>
        </Toolbar>
