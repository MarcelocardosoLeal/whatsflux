...
const useStyles = makeStyles((theme) => ({
  ...
  chatList: {
    ...
    padding: theme.spacing(1), // Add breathing room
  },
  listItem: {
    cursor: "pointer",
    borderRadius: 12, // Modern curved corners
  ...
  selectedItem: {
    ...
    boxShadow: "0 4px 16px rgba(0, 77, 64, 0.4)", // Dark green shadow match
  },
}));
            ...
            {Array.isArray(chats) &&
              ...
              chats.map((chat, key) => (
                <ListItem
                  ...
                  key={key}
                  className={`${classes.listItem} ${chat.uuid === id ? classes.selectedItem : ""}`}
