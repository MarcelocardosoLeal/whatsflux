...
const useStyles = makeStyles((theme) => ({
  ...
  mainPaper: {
    ...
    marginTop: 40,
    borderRadius: 20,
    border: theme.mode === 'light' ? '1px solid #ddd' : 'none',
    boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.1)',
    marginBottom: 40,
    overflow: 'hidden',
    backgroundColor: theme.mode === 'light' ? '#f8f9fa' : 'rgba(0, 0, 0, 0.2)', // Fix Dark Mode
  ...
  mainPaperTable: {
    ...
    height: '68vh',
    borderRadius: '10px',
    backgroundColor: theme.mode === 'light' ? '#ffffff' : 'rgba(255, 255, 255, 0.05)', // Fix Dark Mode
    border: theme.mode === 'light' ? 'none' : '1px solid rgba(255, 255, 255, 0.05)',
  ...
  mainPaperFilter: {
    ...
    height: '30vh',
    padding: '20px',
    backgroundColor: theme.mode === 'light' ? '#f1f3f4' : 'rgba(255, 255, 255, 0.05)', // Fix Dark Mode
    borderRadius: '10px',
    border: theme.mode === 'light' ? 'none' : '1px solid rgba(255, 255, 255, 0.05)',
    boxShadow: '0px 2px 10px rgba(0, 0, 0, 0.05)',
    ...theme.scrollbarStylesSoftBig,
  ...
  connectionTag: {
    background: '#00695C', // Dark Green Standard
    color: '#FFF',
    padding: '5px 10px',
    fontWeight: 'bold',
  ...
  iconButton: {
    color: '#4DB6AC', // Light Green Variation for Icons
    '&:hover': {
      color: '#00695C', // Verde mais escuro no hover
    },
