...
const useStyles = makeStyles((theme) => ({
  mainPaper: {
    ...
    backgroundColor: theme.mode === 'light' ? theme.palette.background.paper : 'rgba(0, 0, 0, 0.2)', // Fix Dark Mode
    backdropFilter: theme.mode === 'light' ? 'none' : 'blur(10px)', // Glass effect
